...
Summary(pl):	Sterowniki dla Linuksa dla kart d德i瘯owych opartych na Aureal Vortex
...
Summary(pl):	Sterownik dla Linuksa SMP dla kart d德i瘯owych opartych na Aureal Vortex
Release:	%{_rel}@%{_kernel_ver_str}
Group:		Base/Kernel
Prereq:		/sbin/depmod
